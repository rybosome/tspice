...
This backend provides a CSPICE-derived `.wasm` artifact. See [`NOTICE`](./NOTICE) for authoritative information on licensing, build provenance, integration, and redistribution details.
