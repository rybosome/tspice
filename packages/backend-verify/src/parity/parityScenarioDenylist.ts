// Generated by: node ./packages/backend-verify/scripts/gen-parity-denylist.mjs --missing --ts
// Source: SpiceBackend contract in packages/backend-contract/src/index.ts
// Extracted from: packages/backend-contract/src/domains/*
// Mode: missing coverage keys (contractKeys - scenarioCalls)
// Scenarios: packages/backend-verify/scenarios/*.yml
