...
`tspice` embeds CSPICE-derived components only as an internal implementation detail to support its TypeScript API, and is not a general-purpose distribution of CSPICE. This section is an overview; see the policy doc for the canonical constraints.
